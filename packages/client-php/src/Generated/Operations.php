...
final class Operations
{
    ...
    public const ALL = [
        ...
        'appointments.cancel' => ['path' => '/appointments/{appointmentId}/cancel', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number', 'body' => ['reason', 'notify_customer']],
        'appointments.create' => ['path' => '/appointments/store', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number', 'body' => ['order_id', 'start_at', 'end_at', 'notify_customer']],
        ...
        'appointments.reschedule' => ['path' => '/appointments/{appointmentId}/reschedule', 'method' => 'PUT', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number', 'body' => ['start_at', 'notify_customer']],
        ...
        'customers.create' => ['path' => '/customers', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'email', 'body' => ['owner_first_name', 'owner_last_name', 'email', 'phone']],
        ...
        'orders.deliver' => ['path' => '/orders/{orderId}/deliver', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number'],
        ...
        'orders.tags.add' => ['path' => '/orders/{orderId}/tags', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number', 'body' => ['tag_id']],
        'orders.tags.remove' => ['path' => '/orders/{orderId}/tags/{tagId}', 'method' => 'DELETE', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number'],
        'payroll.items.create' => ['path' => '/payroll/pay-run-items', 'method' => 'POST', 'availability' => 'unverified', 'mutates' => true, 'confirmField' => 'number', 'body' => ['title', 'amount', 'submitted_date', 'company_team_member_id', 'order_id', 'note']],
